...
assert_ports "daphne -b 0.0.0.0 -p 8006 app.asgi:application" 8006
assert_ports "panel serve dashboard.py --address 0.0.0.0 --port 5007" 5007
assert_ports "mkdocs serve --dev-addr 127.0.0.1:8008" 8008
